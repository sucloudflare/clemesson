  ...
  const sermons = [
    {
      ...
      link: "https://www.youtube.com/watch?v=link1"
    },
    {
      ...
      duration: "38:15",
      image: "https://images.unsplash.com/photo-1490730141103-6cac27aaab94",
      link: "https://www.youtube.com/watch?v=link2"
    },
    {
      ...
      link: "https://www.youtube.com/watch?v=link3"
    }
  ];
              ...
              <div className="p-6">
                ...
                <div className="flex items-center gap-4">
                  <a
                    ...
                    className="flex-1 bg-blue-600 text-white py-2 rounded-lg font-medium hover:bg-blue-700 transition-colors text-center"
                  >
                    Assistir
                  </a>
